                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('user.update', $user) }}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="location" type="text" class="form-control @error('location') is-invalid @enderror" name="location" placeholder="Country" value="{{ old('location', $user->location) }}"  autocomplete="location" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="description" type="text"  class="form-control"  name="description"  autocomplete="description">{{ old('description',$user->description) }}</textarea>
